      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <?php
            include "../koneksi.php";
            $data = $_SESSION['nip'];
            $sql = mysqli_query($koneksi,"select foto from guru where nip = $data");
            while ($r1 = mysqli_fetch_array($sql)) 
            { ?>
                <img src="guru/<?php echo $r1['foto']; ?>" class="img-circle elevation-2" alt="User Image">
            <?php } ?>
          <!---->
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul>
              ...
              <li>
              <a href="laporan1.php" class="nav-link">
                  <i class="nav-icon fas fa-money-check"></i>
                  <p>
                    Laporan guru
                  </p>
